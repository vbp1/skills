...
PLUGINS = [
    ...
    ("cloakbrowser-codex", "CloakBrowser (Codex CLI)",
     "Inspect web pages in a local stealth Chromium: screenshots, client-side JS errors, failed requests, long-task timings. Codex CLI variant.",
     "development", "Coding", ["browser", "screenshots", "devtools", "debugging"], "codex"),
    ...
    ("kill-the-idea", "Kill The Idea",
     "Argue against an idea from the position that it should not be built, with every claim anchored to the code, and end with a verdict.",
     "planning", "Productivity", ["product", "planning", "decision", "review"], "claude"),
    ...
    ("review-panel", "Review Panel",
     "Parallel read-only review tracks over a diff: mechanical triage, one agent per lens, every must-fix finding checked against the code, persisted rounds, re-review until clean.",
