...
PLUGINS = [
    ...
    ("telemost-scribe-api", "Telemost Scribe API (Claude Code)",
     "Query the local Telemost Scribe API: schedules, meetings, transcripts and answers with citations. Claude Code variant.",
     "productivity", "Productivity", ["meetings", "transcripts", "api"], "claude"),
    ("telemost-scribe-api-codex", "Telemost Scribe API (Codex CLI)",
     "Query the local Telemost Scribe API: transcripts, summaries and answers with citations. Codex CLI variant.",
     "productivity", "Productivity", ["meetings", "transcripts", "api"], "codex"),
